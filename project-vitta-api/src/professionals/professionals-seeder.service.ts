...
export class ProfessionalsSeederService implements OnApplicationBootstrap {
  ...
  private async seedProfessionals() {
    ...
    const specialtyMap = new Map(specialties.map(s => [s.name.toUpperCase(), s]));
    ...
    const data = [
       {
        ...
        password: 'Asdfg1234%',
        role: 'provider',
        biography: 'Especialista en nutrición vegana con enfoque integral en el bienestar físico y emocional del paciente.  Apasionada por la educación nutricional y la promoción de estilos de vida sostenibles.',
        ...
        password: 'Asdfg1234%',
        role: 'provider',
        biography: 'Nutriólogo especializado en el tratamiento de trastornos alimenticios, incluyendo anorexia, bulimia y trastorno por atracón.',
        ...
        password: 'Asdfg1234%',
        role: 'provider',
        biography: 'Especialista en salud hormonal, con énfasis en el abordaje nutricional de trastornos tiroideos como hipotiroidismo e hipertiroidismo. Intervención metabólica para adultos con sobrepeso y obesidad.',
