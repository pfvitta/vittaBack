import { BadRequestException, Controller, FileTypeValidator, Param, ParseFilePipe, ParseUUIDPipe, Post, UploadedFile, UseInterceptors, UsePipes } from "@nestjs/common";
...
export class FilesController {
    ...
    @ApiOperation({
        ...
        description: 'Permite subir una imagen válida (jpg, jpeg, png, bmp, gif, webp, svg, ico) asociada a un usuario común o un usuario proveedor mediante su ID. Incluye validación de tipo y tamaño del archivo.'
    })
